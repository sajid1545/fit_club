...
const Questions = () => {
	return (
		<div className="text-center bg-white p-10 mb-10">
			...
			{/* First Question */}
			<div title='Click to see the anwsers' className="w-4/5 mx-auto border-4 border-purple-600 mt-5 rounded-xl shadow-lg hover:shadow-purple-400 duration-500 md:hover:scale-110">
			...
			{/* Second Question */}
			<div title='Click to see the answers' className="w-4/5 mx-auto border-4 border-purple-600 mt-5 rounded-xl shadow-lg hover:shadow-purple-400 duration-500 md:hover:scale-110">
				<div className="collapse">
					<input type="checkbox" />
					<div className="collapse-title text-xl font-semibold underline-offset-8 underline">
